  ...
  - block: markdown
    content:
      ...
      text: |
        ...
        **B. Targeted genome engineering using CRISPR/dCas9**
        M.Sc. projects are available for targeted genome engineering using [CRISPR/dCas9](https://doi.org/10.1016/j.pbi.2025.102810). The aim is to modify the local epi-genome of a target locus by recruiting chromatin-modifying payload proteins through gRNA/DNA interactions. Projects may include characterisation of existing tools we have generated, or the design of new tools.

        **C. RNA Polymerase II elongation and Transcription Start Sites**
        A focus of our research is the interplay between RNA Polymerase II elongation and the inhibition of Transcription Start Sites (TSSs) by the elongating polymerase ([read more](https://doi.org/10.1016/j.tibs.2020.07.009)). Projects dissecting the interplay between chromatin organisation and TSSs are available — for example, using genome-wide methods to detect TSSs in chromatin mutants, or by targeted dissection of these events at target loci.

        ---

        Interested? Please [get in touch](../contact/) with a brief description of your background and interests!
    design:
      columns: '1'
---
